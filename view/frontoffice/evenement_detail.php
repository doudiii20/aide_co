    ...
    <header class="main-header">
        <div class="header-content">
            ...
            <nav class="nav-links">
                ...
                <a href="http://localhost/eventsCopy/view/frontoffice/evenements.php" class="nav-link">
        ...
        <div class="event-detail-card">
            <div class="event-hero">
                ...
                ?>
                    <img src="http://localhost/eventsCopy/uploads/<?= htmlspecialchars($ev['image']) ?>" 
                         ...
                         onerror="this.parentElement.innerHTML = '<div class=\'image-placeholder\'><i class=\'fa-regular fa-image\'></i><span>Image non disponible</span></div>'">
                <?php else: ?>
            ...
            <div class="event-details">
                ...
                <div class="action-section">
                    ...
                    <a href="http://localhost/eventsCopy/view/frontoffice/evenements.php" class="btn btn-outline">
                        <i class="fa-solid fa-arrow-left"></i> Retour aux événements
                    </a>
                </div>
            </div>
